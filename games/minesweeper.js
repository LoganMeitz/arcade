...
export class Minesweeper extends Game {
  ...
  constructor(boardID = null){
    super();
    if (!boardID) boardID = Minesweeper.generateMinesweeperID(8, 10);
    ...
    this.view.appendChild(minecount);
    this.view.appendChild(gameBoard);
    this.view.classList.add('minesweeper'); // think about moving this one off too
    
    // This must be removed at some point
    document.getElementById('hidden').innerHTML = '';
    document.getElementById('hidden').appendChild(this.view);
  ...
  static generateMinesweeperID(size, mines){
